...
from hdldepends import __version__
...
project = "hdldepends"
copyright = f"{date.today().year}, Pev"
author = "Pev"
...
# LinkCode
code_url = f"https://github.com/pevhall/hdl-dependencies/blob/{git_commit}"
